...
def add_manifest(archive: zipfile.ZipFile, dist_info_dir: Path) -> None:
    """
    ...
    lines.append(record_path.as_posix() + ",,")
    RECORD = "\n".join(lines)
    archive.writestr(
...
def wheelmeta_builder(target: Union[str, Path]) -> None:
