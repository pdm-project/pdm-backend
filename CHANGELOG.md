...
- Allow writing dynamic version from `scm` source to a file. [#94](https://github.com/pdm-project/pdm-pep517/issues/94)
...
- Drop the support for Python < 3.7. [#72](https://github.com/pdm-project/pdm-pep517/issues/72)
